...
func (*BookInfoParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_book_2b9d848b22656b6f, []int{0}
}
...
func (*BookInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_book_2b9d848b22656b6f, []int{1}
}
...
func (*BookListParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_book_2b9d848b22656b6f, []int{2}
}
...
func (dst *BookListParams) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BookListParams.Merge(dst, src)
}
...
func (*BookList) Descriptor() ([]byte, []int) {
	return fileDescriptor_book_2b9d848b22656b6f, []int{3}
}
...
func init() { proto.RegisterFile("book.proto", fileDescriptor_book_2b9d848b22656b6f) }

var fileDescriptor_book_2b9d848b22656b6f = []byte{
